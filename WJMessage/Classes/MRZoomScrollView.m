...
//    imageView.frame = CGRectMake(0, 50, MRScreenWidth * 2.5, 320 * 2.5);//修改原作者的代码，满足自己需求，让图片显示再视图中间，对i5会不太好看。
...
//    [self setZoomScale:minimumScale];
    ...
    imageView = [[EGOImageView alloc] initWithPlaceholderImage:[UIImage imageNamed:@"p.png"]];
